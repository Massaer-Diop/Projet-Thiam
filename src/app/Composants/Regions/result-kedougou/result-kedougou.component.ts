...
@Component({
  selector: 'app-result-kedougou',
  templateUrl: './result-kedougou.component.html',
  styleUrls: ['./result-kedougou.component.css']
})
export class ResultKedougouComponent implements OnInit {
