...
@Component({
  selector: 'app-result-louga',
  templateUrl: './result-louga.component.html',
  styleUrls: ['./result-louga.component.css']
})
export class ResultLougaComponent implements OnInit {
