...
@Component({
  selector: 'app-result-fatick',
  templateUrl: './result-fatick.component.html',
  styleUrls: ['./result-fatick.component.css']
})
export class ResultFatickComponent implements OnInit {
  commune!: any
  region!: any
  candidats!: any
