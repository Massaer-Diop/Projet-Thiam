...
@Component({
  selector: 'app-result-sedhiou',
  templateUrl: './result-sedhiou.component.html',
  styleUrls: ['./result-sedhiou.component.css']
})
export class ResultSedhiouComponent implements OnInit {
