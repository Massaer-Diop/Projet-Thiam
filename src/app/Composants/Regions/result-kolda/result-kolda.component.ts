...
@Component({
  selector: 'app-result-kolda',
  templateUrl: './result-kolda.component.html',
  styleUrls: ['./result-kolda.component.css']
})
export class ResultKoldaComponent implements OnInit {
